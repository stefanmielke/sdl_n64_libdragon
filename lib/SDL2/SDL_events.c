...
#define GP_EVENT(BUTTON)                                                                           \
	{                                                                                              \
		SDL_Event event;                                                                           \
		event.type = SDL_KEYUP ? SDL_CONTROLLERBUTTONUP : SDL_CONTROLLERBUTTONDOWN;                \
		event.cbutton.which = c_num;                                                               \
		event.cbutton.state = SDL_KEYUP ? SDL_RELEASED : SDL_PRESSED;                              \
